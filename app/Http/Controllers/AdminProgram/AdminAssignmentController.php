...
$assignments = $query->orderBy('due_date', 'asc')->paginate(10); // 10 item per halaman



        return view('adminprogram.assignments.index', compact('assignments', 'programId'));
    }
    ...
    public function create()
    {
        ...
        return view('adminprogram.assignments.create', compact('programs', 'kelasList'));
    }
...
Assignment::create($request->only([
    ...
    'is_published'
        ...
        return redirect()->route('adminprogram.assignments.index')
    ...
    public function edit($id)
    {
        ...
        return view('adminprogram.assignments.edit', compact('assignment', 'programs', 'kelasList'));
    }
    ...
    public function submissions($id)
    {
        ...
        return view('adminprogram.assignments.submissions', compact('assignment'));
    }
    ...
    /**
     * Download semua submission sebagai PDF / Excel
     */
    public function downloadAllSubmissions($assignmentId)
    {
        ...
        $pdf = PDF::loadView('adminprogram.assignments.pdf-all', compact('assignment', 'submissions'));
