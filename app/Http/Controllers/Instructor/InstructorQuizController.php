...
class InstructorQuizController extends Controller
{
    ...
    public function index($programId = null)
    {
        ...
        return view('instructor.quiz.index', compact('quizzes', 'programId'));
    }
    ...
    public function create()
    {
        ...
        return view('instructor.quiz.create', compact('programs', 'kelasList'));
    }
...
$request->validate([
    ...
    'is_published' => 'sometimes|boolean', // dulu required
]);
    ...
    public function edit($id)
    {
        ...
        return view('instructor.quiz.edit', compact('quiz', 'programs', 'kelasList'));
    }
    ...
    public function submissions($quizId)
    {
        ...
        return view('instructor.quiz.submissions', compact('quiz'));
    }
    ...
    {
        $quiz = Quiz::with(['quizAttempts.user'])->findOrFail($quizId);
        $pdf = PDF::loadView('instructor.quiz.pdf-all', compact('quiz'));
