...
@media (max-width: 768px) {
    ...
    .goog-te-gadget-simple {
        ...
        /* Flexible grid for content sections */
        .flexible-grid {
            display: grid;
...
<body class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300 font-poppins">
    ...
    <!-- Main Content -->
 <div class="content-card space-y-8 py-8 px-4 relative z-10">
    <!-- Logo Section -->
    <div class="text-center">
        <div class="flex justify-center mb-4">
            ...
            <img
                ...
                alt="Logo Light"
                class="w-[180px] h-auto dark:hidden max-w-full"
            >
            ...
            <img
                ...
                alt="Logo Dark"
                class="w-[180px] h-auto hidden dark:block max-w-full"
            >
        </div>
    </div>
    ...
    <div class="text-center text-sm text-gray-500 dark:text-gray-400">
        @hasSection('footer-links')
            @yield('footer-links')
        @else
            &copy; {{ date('Y') }} yota inovasi nusantara. All rights reserved.
        @endif
    </div>
</div>
