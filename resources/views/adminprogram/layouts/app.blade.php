    ...
    <a href="{{ route('adminprogram.programs.index') }}"
       ...
       :class="{
           'bg-primary-50 dark:bg-gray-700 border-l-4 border-primary-500 text-primary-600
            ...
            $page.url.startsWith('/adminprogram/programs')
       }">
        <i class="fa-solid fa-users-gear w-5 text-center"></i>
        <span class="ml-3 sidebar-text">Kelola Program</span>
    </a>
</li>
...
<li>
    <a href="{{ route('adminprogram.participants.index') }}"
       ...
       :class="{
           'bg-primary-50 dark:bg-gray-700 border-l-4 border-primary-500 text-primary-600
            dark:text-primary-400 font-semibold':
            $page.url.startsWith('/adminprogram/participants')
       }">
        <i class="fa-solid fa-users w-5 text-center"></i>
        <span class="ml-3 sidebar-text">Kelola Peserta Program</span>
    </a>
</li>
<li>
    <a href="{{ route('adminprogram.ni.index') }}"
       class="flex items-center p-3 rounded-lg menu-item text-gray-700 dark:text-gray-300
              hover:bg-primary-50 dark:hover:bg-gray-700 transition-colors
              {{ request()->routeIs('adminprogram.ni.*') ? 'bg-primary-50 dark:bg-gray-700 border-l-4 border-primary-500 text-primary-600 dark:text-primary-400 font-bold' : '' }}">

        <i class="fas fa-barcode w-5 text-center"></i>
        <span class="ml-3 sidebar-text">Buat Nomor Induk</span>
    </a>
</li>
...
<li>
    {{-- 1. Href mengarah ke route 'index' (halaman pilih program), bukan 'indexByProgram' --}}
    <a href="{{ route('adminprogram.resources.index') }}"
       class="flex items-center p-3 rounded-lg menu-item text-gray-700 dark:text-gray-300
              hover:bg-primary-50 dark:hover:bg-gray-700
              {{-- 2. Logika Active State: Gunakan helper Laravel agar lebih akurat --}}
              {{ request()->routeIs('adminprogram.resources.*') ? 'bg-primary-50 dark:bg-gray-700 border-l-4 border-primary-500 text-primary-600 dark:text-primary-400 font-semibold' : '' }}"
    >
        <i class="fa-solid fa-book w-5 text-center"></i>
        <span class="ml-3 sidebar-text">Manajemen Materi / Lampiran</span>
    </a>
</li>
<!-- Kelola Ujian & Tugas -->
<li x-data="{ open: false }">
    ...
    <ul x-show="open" class="pl-8 mt-1 space-y-1" style="display: none;">
        ...
        <li>
            <a href="{{ route('adminprogram.assignments.index') }}"
               class="block p-2 rounded-lg text-gray-600 hover:bg-primary-50 dark:text-gray-400 dark:hover:bg-gray-700">
               Kelola Tugas
            </a>
        </li>
        <li>
            <a href="{{ route('adminprogram.essay.index') }}"
               class="block p-2 rounded-lg text-gray-600 hover:bg-primary-50 dark:text-gray-400 dark:hover:bg-gray-700">
               Kelola Ujian Tulis
            </a>
        </li>
                <li>
            <a href="{{ route('adminprogram.piagam.programs') }}"
               class="block p-2 rounded-lg text-gray-600 hover:bg-primary-50 dark:text-gray-400 dark:hover:bg-gray-700">
               Kelola Piagam
            </a>
        </li>
                ...
                <li>
                    <a href="{{ route('adminprogram.announcements.index') }}" class="flex items-center p-3 rounded-lg menu-item text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-gray-700"
                ...
                <li>
@php
    $program = auth()->user()->administeredPrograms()->first();
@endphp

@if($program)
    <a href="{{ route('adminprogram.narasumber.index', $program->id) }}"
       class="flex items-center p-3 rounded-lg menu-item text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-gray-700">
       <i class="fas fa-users w-5 text-center"></i> Narasumber
    </a>
@endif
        ...
        <!-- Diskusi -->
        <li>
<a href="{{ route('adminprogram.discussion.index') }}"
   class="flex items-center p-3 rounded-lg menu-item text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-gray-700"
   :class="{ 'bg-primary-50 dark:bg-gray-700 border-l-4 border-primary-500 text-primary-600 dark:text-primary-400 font-semibold': $page.url.startsWith('/discussion') }">
    ...
    <span class="ml-3 sidebar-text">Diskusi</span>
        ...
        <li>
<a href="{{ route('adminprogram.eraport.index', $programActive->id ?? 1) }}"
   class="flex items-center p-3 rounded-lg menu-item text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-gray-700"
