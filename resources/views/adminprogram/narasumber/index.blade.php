...
<div class="container mx-auto p-6 max-w-6xl">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('adminprogram.narasumber.create', $program->id) }}" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">
            Tambah Narasumber
        </a>
    </div>
...
<td class="px-6 py-4">
    <div class="flex items-center justify-center gap-2">
        <!-- Lihat Button -->
        <a href="{{ route('adminprogram.narasumber.show', [$program->id, $n->id]) }}"
        ...
        <!-- Edit Button -->
        <a href="{{ route('adminprogram.narasumber.edit', [$program->id, $n->id]) }}"
        ...
        <!-- Delete Button -->
        <form action="{{ route('adminprogram.narasumber.destroy', [$program->id, $n->id]) }}" method="POST" class="inline-block">
            @csrf
            @method('DELETE')
            <button type="submit"
