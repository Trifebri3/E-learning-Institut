    ...
    <div class="mb-8">
        ...
        <div class="flex justify-between items-start">
            ...
            <div class="flex gap-2">
                <a href="{{ route('adminprogram.narasumber.edit', [$program->id, $narasumber->id]) }}"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-md mx-4">
        <div class="text-center">
            ...
            <div class="flex gap-3 justify-center">
                ...
                <form id="delete-form" action="{{ route('adminprogram.narasumber.destroy', [$program->id, $narasumber->id]) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
