    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <form action="{{ route('adminprogram.quizzes.update', $quiz->id) }}" method="POST">
                    @csrf
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <div class="btn-group ml-3">
                                            ...
                                            <form action="{{ route('adminprogram.questions.destroy', $question->id) }}"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('adminprogram.kelas.edit', $quiz->kelas_id) }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i> Kembali ke Kelas
                        </a>
                        <form action="{{ route('adminprogram.quizzes.destroy', $quiz->id) }}" method="POST" class="d-grid">
                            @csrf
                            @method('DELETE')
...
<div class="modal fade" id="addQuestionModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('adminprogram.questions.store', $quiz->id) }}" method="POST" enctype="multipart/form-data" id="addQuestionForm">
                @csrf
