...
<div class="container mx-auto p-6 max-w-4xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('adminprogram.essay.submissions', $submission->essay_exam_id) }}" class="text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-100 dark:border-gray-700 p-6">
            ...
            <form action="{{ route('adminprogram.essay.grade.save', $ans->id) }}" method="POST" class="space-y-4">
                @csrf
...
<textarea name="feedback" class="w-full border rounded p-2">{{ $ans->notes }}</textarea>
                    </div>
                </div>
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
        <form action="{{ route('adminprogram.essay.grade.finish', $submission->id) }}" method="POST">
            @csrf
