...
<div class="container mx-auto p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('adminprogram.essay.submissions.preview', $exam->id) }}"
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button type="button"
                                                onclick="openEditModal({{ $s->id }}, {{ $s->final_score ?? 'null' }}, `{{ $s->admin_feedback ?? '' }}`)"
                                                class="px-2 py-1 text-xs bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-300 rounded">
                                            ✏️ Edit
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <a href="{{ route('adminprogram.essay.submissions.print', $s->id) }}"
...
function openEditModal(submissionId, finalScore, adminFeedback) {
    ...
    // Set form action
form.action = "{{ url('adminprogram/essay/submission') }}/" + submissionId + "/final-score";


    // Set values
    form.querySelector('input[name="final_score"]').value = finalScore;
    form.querySelector('textarea[name="admin_feedback"]').value = adminFeedback;
