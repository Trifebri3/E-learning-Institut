...
<div class="container mx-auto p-6">
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route('adminprogram.assignments.submissions.download', $assignment->id) }}"
        ...
        <table class="w-full table-auto border border-gray-200 dark:border-gray-700">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-4 py-2 border-b">
                        <form action="{{ route('adminprogram.assignments.submissions.updateScore', $s->id) }}" method="POST" class="flex flex-col gap-1">
                            @csrf
                            @method('PUT')
                    ...
                    <td class="px-4 py-2 border-b">
                        <form action="{{ route('adminprogram.assignments.submissions.updateScore', $s->id) }}" method="POST">
                            @csrf
                            @method('PUT')
