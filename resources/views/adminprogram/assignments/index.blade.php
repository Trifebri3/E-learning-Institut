...
<div class="container mx-auto p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('adminprogram.assignments.create') }}"
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="{{ route('adminprogram.assignments.edit', $a->id) }}"
                                    ...
                                    <a href="{{ route('adminprogram.assignments.submissions', $a->id) }}"
                                    ...
                                    <form action="{{ route('adminprogram.assignments.destroy', $a->id) }}" method="POST" class="inline">
                                        @csrf @method('DELETE')
                                        <button type="submit"
