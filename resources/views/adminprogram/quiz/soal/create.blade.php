...
<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <form action="{{ route('adminprogram.quiz.soal.store', $quiz->id) }}" method="POST">
        @csrf
        ...
        <div class="mt-4 flex gap-2">
            ...
            <a href="{{ route('adminprogram.quiz.soal.index', $quiz->id) }}" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">
