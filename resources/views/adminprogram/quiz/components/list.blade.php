<div class="mt-4">
    <div class="flex justify-between items-center mb-2">
        ...
        <a href="{{ route('adminprogram.quiz.create', ['kelas_id' => $kelas->id]) }}"
            ...
            @foreach($quizzes as $quiz)
                <div class="border p-3 rounded flex justify-between items-center hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <div class="flex gap-2">
                        ...
                        <form action="{{ route('adminprogram.quiz.destroy', $quiz->id) }}" method="POST" onsubmit="return confirm('Hapus quiz ini?');">
                            @csrf
                            @method('DELETE')
