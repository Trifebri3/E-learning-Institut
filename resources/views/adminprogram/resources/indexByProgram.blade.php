            ...
            <div class="px-4 py-2 sm:p-0">
                            ...
                            <li class="py-4 sm:px-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        <a href="{{ route('adminprogram.resources.edit', $resource->id) }}" class="text-gray-400 hover:text-yellow-500 dark:hover:text-yellow-400 transition-colors">
                                        ...
                                        <form action="{{ route('adminprogram.resources.destroy', $resource->id) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
                ...
                @else
                    <div class="py-10 text-center">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('adminprogram.resources.create', $kelas->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
