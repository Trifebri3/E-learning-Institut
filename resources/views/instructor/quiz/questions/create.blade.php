    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
        ...
        <form action="{{ route('instructor.quiz.questions.store', $quiz->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="type"
                    class="w-full rounded-lg border-gray-300 dark:bg-gray-700 dark:text-white
                           focus:ring-green-500 focus:border-green-500"
                    required>
                    <option value="multiple_choice" @selected(old('type') == 'multiple_choice')>
                        Pilihan Ganda
                    </option>
                    <option value="essay" @selected(old('type') == 'essay')>
                        Essay
                    </option>
                </select>
            </div>
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-bold
