...
<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <a href="{{ route('instructor.quiz.soal.create', $quiz->id) }}"
        ...
        <tbody>
            ...
            <tr class="border-b">
                ...
                <td class="px-4 py-2 flex gap-2">
                    <a href="{{ route('instructor.quiz.soal.edit', [$quiz->id, $question->id]) }}"
                       class="px-2 py-1 bg-blue-600 text-white rounded hover:bg-blue-700">Edit</a>
                    <form action="{{ route('instructor.quiz.soal.destroy', [$quiz->id, $question->id]) }}" method="POST" onsubmit="return confirm('Yakin ingin hapus soal?');">
                        @csrf
                        @method('DELETE')
