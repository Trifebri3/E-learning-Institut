...
<div class="container mx-auto p-6 max-w-5xl">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('instructor.kelas.edit', $learningPath->kelas_id) }}" class="text-gray-500 hover:text-indigo-600 flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border dark:border-gray-700 sticky top-6">
                ...
                <form action="{{ route('instructor.learningpath.update', $learningPath->id) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="mb-4">
                ...
                <div class="mt-8 pt-4 border-t dark:border-gray-600">
                    <form action="{{ route('instructor.learningpath.destroy', $learningPath->id) }}" method="POST" onsubmit="return confirm('Yakin hapus kurikulum ini? Semua bab dan progress peserta akan hilang!');">
                        @csrf @method('DELETE')
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow border dark:border-gray-700 overflow-hidden">
                <div class="p-4 border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 flex justify-between items-center">
                    ...
                    <a href="{{ route('instructor.learningpath.section.create', $learningPath->id) }}" class="px-3 py-1.5 bg-green-600 text-white text-sm font-bold rounded hover:bg-green-700">
                    ...
                    @forelse($learningPath->sections as $section)
                        <div class="flex items-center justify-between p-4 border dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition group">
                            ...
                            <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition">
                                <a href="{{ route('instructor.learningpath.section.edit', $section->id) }}" class="p-2 text-blue-600 hover:bg-blue-50 rounded" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('instructor.learningpath.section.destroy', $section->id) }}" method="POST" onsubmit="return confirm('Hapus bab ini?');">
                                    @csrf @method('DELETE')
