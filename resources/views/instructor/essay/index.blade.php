...
<div class="container mx-auto p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('instructor.essay.create') }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg shadow">
            + Buat Ujian Baru
        </a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                        <a href="{{ route('instructor.essay.edit', $exam->id) }}" class="text-yellow-600 hover:text-yellow-900 dark:text-yellow-400 dark:hover:text-yellow-300">Edit</a>
                        <a href="{{ route('instructor.essay.questions', $exam->id) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">Soal</a>
                        <a href="{{ route('instructor.essay.submissions', $exam->id) }}" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300">Submission</a>
                        <form action="{{ route('instructor.essay.destroy', $exam->id) }}" method="POST" class="inline">
                            @csrf @method('DELETE')
