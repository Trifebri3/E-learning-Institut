...
<div class="container mx-auto p-6 max-w-4xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('instructor.essay.index') }}" class="text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
...
{{-- Form untuk delete --}}
<form id="delete-{{ $q->id }}" action="{{ route('instructor.essay.questions.delete', $q->id) }}" method="POST" class="hidden">
    @csrf
    @method('DELETE')
</form>
