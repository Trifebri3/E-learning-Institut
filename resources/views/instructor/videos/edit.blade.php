...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('instructor.kelas.edit', $video->kelas_id) }}" class="text-gray-500 hover:text-indigo-600 flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
            <form action="{{ route('instructor.videos.update', $video->id) }}" method="POST" id="edit-video-form">
                @csrf
                @method('PUT')
            ...
            <form id="delete-form" action="{{ route('instructor.videos.destroy', $video->id) }}" method="POST" style="display: none;" onsubmit="return confirm('Yakin ingin menghapus video ini? Data tonton peserta juga akan hilang.');">
                @csrf
                @method('DELETE')
            </form>
        </div>
