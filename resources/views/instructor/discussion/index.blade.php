...
<div class="h-[calc(100vh-5rem)] flex bg-white dark:bg-gray-900 overflow-hidden">
    ...
    <div class="w-full md:w-1/3 lg:w-1/4 border-r border-gray-200 dark:border-gray-700 flex flex-col bg-gray-50 dark:bg-gray-800">
        <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-600 text-white">
            <h2 class="text-xl font-bold"><i class="fas fa-comments mr-2"></i> Instruktur Chat</h2>
        </div>
        ...
        <div class="flex-1 overflow-y-auto p-2 space-y-6">
            ...
            <div>
                ...
                @foreach($forums as $forum)
                    <a href="{{ route('instructor.discussion.forum', $forum->id) }}"
            ...
            <div>
                ...
                @foreach($contacts as $contact)
                    <a href="{{ route('instructor.discussion.dm', $contact->id) }}"
    ...
    @endphp
            ...
            <div class="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                <form action="{{ isset($activeForum) ? route('instructor.discussion.forum.store', $activeForum->id) : route('instructor.discussion.dm.store', $otherUser->id) }}"
