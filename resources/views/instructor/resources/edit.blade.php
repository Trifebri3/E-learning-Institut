...
<div class="max-w-3xl mx-auto py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('instructor.resources.indexByProgram', $resource->kelas->program_id) }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
            &larr; Kembali
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        <div class="p-6 space-y-6">
            ...
            <form action="{{ route('instructor.resources.update', $resource->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="pt-5 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
                    <a href="{{ route('instructor.resources.indexByProgram', $resource->kelas->program_id) }}"
