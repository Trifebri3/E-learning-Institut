    ...
    <div class="mb-4 flex items-center justify-between">
        <label class="inline-flex items-center">
            <input id="remember_me"
                   type="checkbox"
                   name="remember"
                   class="rounded border-gray-300 dark:border-gray-600 text-primary-600 shadow-sm focus:ring-primary-500 dark:bg-gray-700 dark:focus:ring-primary-600"
    ...
    <div class="text-center">
        <div class="relative mb-4">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-white dark:bg-gray-800 text-gray-500">Atau lanjutkan dengan</span>
            </div>
        </div>
...
<div class="flex justify-center space-x-4">
    <span class="text-gray-500 dark:text-gray-400 text-sm">Belum punya akun?</span>
    <a href="{{ route('register') }}" class="text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 text-sm font-medium transition-colors duration-200">
        Daftar di sini
    </a>
</div>
@endsection
